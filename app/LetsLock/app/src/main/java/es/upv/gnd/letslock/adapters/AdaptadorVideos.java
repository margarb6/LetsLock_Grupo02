...
public class AdaptadorVideos extends RecyclerView.Adapter<AdaptadorVideos.VideoViewHolder> {
    ...
    public AdaptadorVideos() {
    }

    public AdaptadorVideos(List<Videos> youtubeVideoList) {
    ...
    public VideoViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from( parent.getContext()).inflate(R.layout.video_lista, parent, false);
