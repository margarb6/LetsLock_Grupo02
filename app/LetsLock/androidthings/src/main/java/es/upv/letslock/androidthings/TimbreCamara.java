 ...
 */
public class TimbreCamara {
    private static final String TAG = TimbreCamara.class.getSimpleName();
    ...
    private TimbreCamara() {
    }

    private static class InstanceHolder {
        private static TimbreCamara mCamera = new TimbreCamara();
    }

    public static TimbreCamara getInstance() {
